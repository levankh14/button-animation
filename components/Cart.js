    ...
    <View style={styles.cont}>
      <TouchableOpacity
        onPress={() => {
          ...
          secondTextOpacityValue.value = withDelay(100, withTiming(1,{duration:100}, ()=>{
            secondTextOpacityValue.value = withDelay(1000, withTiming(0,{duration:100}))
          }))
          thirdTextOpacityValue.value = withDelay(1150, withTiming(1, {duration:100}))
